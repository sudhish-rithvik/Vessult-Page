  ...
  return (
    <section className="relative section-padding overflow-hidden" ref={ref}>
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 50% 40% at 50% 50%, rgba(37,99,235,0.06) 0%, transparent 60%)' }}
      />
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            >
              <span
                className="text-sm font-semibold"
                style={{ color: '#F87171', fontFamily: "'Stack Sans Text', sans-serif" }}
              >
            ...
            >
              <span
                className="text-sm font-semibold"
                style={{ color: '#60A5FA', fontFamily: "'Stack Sans Text', sans-serif" }}
              >
                Vessult Systems
              </span>
            </div>
