  ...
  return (
    <section className="relative section-padding overflow-hidden" ref={ref} style={{ background: '#FFFFFF' }}>
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 70% 50% at 80% 50%, rgba(37,99,235,0.03) 0%, transparent 65%)' }}
      />
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: '#64748B', fontFamily: "'Stack Sans Text', sans-serif" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {offices.map((office, i) => (
            <motion.div
              ...
              style={{
                background: office.isHQ ? 'rgba(37,99,235,0.05)' : '#FFFFFF',
                border: office.isHQ
              ...
              whileHover={{
                ...
                boxShadow: `0 8px 30px ${office.color}12`,
                y: -4,
              }}
            >
              {/* HQ badge */}
              ...
              <div
                ...
                style={{ background: `${office.color}10`, border: `1px solid ${office.color}25` }}
              >
              ...
              <div
                ...
                style={{ background: `linear-gradient(90deg, transparent, ${office.color}50, transparent)` }}
              />
            </motion.div>
          ))}
        </div>
